...
/**
 * Purpose:
 * Closes every page with brand reassurance, direct contact channels,
 * navigation shortcuts, and the San Lorenzo location for buyers who need
      ...
      <div className="ft-inner">
        <div className="ft-top">
          ...
          <div className="ft-col">
            ...
            <a
              className="ft-link"
              href="mailto:soltexventas@gmail.com"
          ...
          <div className="ft-col">
            ...
            <Link className="ft-link" to="/productos">
              Productos
            </Link>

            <Link className="ft-link" to="/contacto">
              Contacto
            </Link>
          </div>
